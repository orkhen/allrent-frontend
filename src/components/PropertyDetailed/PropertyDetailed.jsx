  ...
  return (
    <div className='property-detailed'>
      <div className="property-detailed-container">
        ...
        <div className="property-detailed-main">
            <PropertyImages/>
            <PropertyCategory/>
            <PropertyOpinion/>

            <div className="property-detailed-reserve text-center">
                <a href='' className='property-detailed-reserve-button mx-auto'>
            ...
            <div className="property-detailed-map">

            </div>

            <div className="property-detailed-comments">
