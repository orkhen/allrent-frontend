        ...
        <div className="search-page-inputs-container gap-2">
            <div className="inputs-box region-input d-flex gap-3">
                ...
                <Autocomplete
                  ...
                  // sx={{ width: 300 }}
                  sx={{
                    // alignSelf: 'center', // Centers the component vertically in the flex container
                    // width: '100%',
            ...
            <div className="inputs-box dates-input d-flex gap-3">
                ...
                <input type='text' value={'14.01.23-16.01.23'} />
            </div>

            <div className="inputs-box guests-input d-flex gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
