            ...
            <Container fluid className='navbar-container justify-content-between'>
                ...
                <div className='navbar-links d-flex flex-column align-items-center justify-content-center navbar-state'>
                    ...
                    <div className='noselect d-flex align-items-center'>
                        <div className='navbar-link profile' onClick={() => activeDropdown !== '' ? setActiveDropdown('') : setActiveDropdown('main-dropdown')}>
                        ...
                        <Dropdown show={activeDropdown === 'main-dropdown'} className='mt-5'>
                            <Dropdown.Menu align={'end'}>
                                ...
                                <Dropdown.Divider />
                                <Dropdown.Item href="" className='d-flex gap-3' onClick={() => setActiveDropdown('account-dropdown')}>
                                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Dropdown.Item href="/favorites" className='d-flex gap-3'>
                                ...
                                <Dropdown.Item href="/reservations" className='d-flex gap-3'>
                                ...
                                <Dropdown.Item href="" className='d-flex gap-3' onClick={() => setActiveDropdown('control-dropdown')}>
                                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Dropdown show={activeDropdown === 'account-dropdown'} className='mt-5'>
                            <Dropdown.Menu align={'end'}>
                                ...
                                <Dropdown.Item href="" className='d-flex gap-3'>
                                    ...
                                    <p className='mb-0'>Giriş və təhlükəsizlik</p>
                                </Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>

                        <Dropdown show={activeDropdown === 'control-dropdown'} className='mt-5'>
                            <Dropdown.Menu align={'end'}>
                                <Dropdown.Item href="" className='d-flex gap-3' onClick={() => setActiveDropdown('main-dropdown')}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 16 14" fill="none">
                                        <path d="M7.70711 0.292893C8.09763 0.683418 8.09763 1.31658 7.70711 1.70711L3.41421 6H15C15.5523 6 16 6.44771 16 7C16 7.55228 15.5523 8 15 8H3.41421L7.70711 12.2929C8.09763 12.6834 8.09763 13.3166 7.70711 13.7071C7.31658 14.0976 6.68342 14.0976 6.29289 13.7071L0.292893 7.70711C0.105357 7.51957 0 7.26522 0 7C0 6.73478 0.105357 6.48043 0.292893 6.29289L6.29289 0.292893C6.68342 -0.0976311 7.31658 -0.0976311 7.70711 0.292893Z" fill="#0D0D0D"/>
                                ...
                                <Dropdown.Divider />
                                <Dropdown.Item href="" className='d-flex gap-3'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 23 19" fill="none">
                                        <path d="M18.6837 17.4167H15.9337V15.5833H18.6837V17.4167ZM18.6837 13.75H15.9337V11.9167H18.6837V13.75ZM18.6837 10.0833H15.9337V8.25H18.6837V10.0833ZM22.3503 5.31667C21.9837 2.29167 19.417 0 16.392 0C14.8337 0 13.2753 0.641667 12.1753 1.74167C11.5337 2.38333 11.0753 3.025 10.8003 3.85L14.6503 6.41667H20.517V18.3333H22.3503V5.31667ZM12.542 4.58333C13.092 2.93333 14.6503 1.83333 16.392 1.83333C18.1337 1.83333 19.692 2.93333 20.242 4.58333H12.542ZM7.22534 3.66667L0.350342 8.25V18.3333H14.1003V8.25L7.22534 3.66667ZM12.267 16.5H9.51701V11H4.93368V16.5H2.18368V9.16667L7.22534 5.95833L12.267 9.16667V16.5Z" fill="#1D1D1D"/>
                                        <path d="M18.6837 17.4167H15.9337V15.5833H18.6837V17.4167ZM18.6837 13.75H15.9337V11.9167H18.6837V13.75ZM18.6837 10.0833H15.9337V8.25H18.6837V10.0833ZM22.3503 5.31667C21.9837 2.29167 19.417 0 16.392 0C14.8337 0 13.2753 0.641667 12.1753 1.74167C11.5337 2.38333 11.0753 3.025 10.8003 3.85L14.6503 6.41667H20.517V18.3333H22.3503V5.31667ZM12.542 4.58333C13.092 2.93333 14.6503 1.83333 16.392 1.83333C18.1337 1.83333 19.692 2.93333 20.242 4.58333H12.542ZM7.22534 3.66667L0.350342 8.25V18.3333H14.1003V8.25L7.22534 3.66667ZM12.267 16.5H9.51701V11H4.93368V16.5H2.18368V9.16667L7.22534 5.95833L12.267 9.16667V16.5Z"/>
                                    </svg>
                                    <p className='mb-0'>Obyektlərim</p>
                                </Dropdown.Item>
                                <Dropdown.Item href="/reservations" className='d-flex gap-3'>
                                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20.8683 6.23828V19.018C20.8683 20.6792 19.5215 22.026 17.8602 22.026H6.14047C4.47924 22.026 3.13245 20.6792 3.13245 19.018V6.23828" stroke="#1D1D1D" stroke-width="1.5" stroke-miterlimit="10" stroke-linejoin="round"></path>
                                        <path d="M21.0001 8V6H3.00012V8" stroke="#1D1D1D" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M6.00024 6V2" stroke="#1D1D1D" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M10.0002 6V2" stroke="#1D1D1D" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M14.0002 6V2" stroke="#1D1D1D" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M18.0002 6V2" stroke="#1D1D1D" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M7.74194 13.4042L11.1567 17.0326L16.2581 11.6133" stroke="#1D1D1D" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                    <p className='mb-0'>Rezervasiyalar</p>
                                </Dropdown.Item>
                                ...
                                <Dropdown.Item href="" className='d-flex gap-3'>
                                    ...
                                    <p className='mb-0'>Yeni obyekt əlavə et</p>
                                </Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                    </div>
